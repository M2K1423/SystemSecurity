...
<body>
<div class="container">
    <h1>Kết quả xác minh chữ ký đơn hàng</h1>
    ...
    <p style="color:green; font-size: 18px; font-weight: bold;">✅ Chữ ký HỢP LỆ - Chủ đơn hàng đã được xác thực.</p>
    <% } else { %>
    <p style="color:red; font-size: 18px; font-weight: bold;">❌ Chữ ký KHÔNG HỢP LỆ - Dữ liệu đã bị thay đổi hoặc không đúng chứng thư.</p>
    <% } %>

    <% } else { %>
    <p style="color:red;">Không có dữ liệu đơn hàng để xác minh.</p>
    <% } %>
